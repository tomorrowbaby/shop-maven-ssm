...
<script type="text/javascript">
                    ...
                    <ul class="submenu">
                    <li class="home"><a href="${pageContext.request.contextPath }/list.action" name="Order_handling.html" title="订单处理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单处理</a></li>
                   </ul>
				  </li>
